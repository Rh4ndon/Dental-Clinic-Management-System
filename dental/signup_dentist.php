            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="controllers/register.php" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="register_dentist" type="submit">Create Account</button>
                    </div>
                    <div class="col-12">
